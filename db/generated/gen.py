...
//<![CDATA[
var gl = window.gl || {};
gl.startup_calls = {"/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py?format=json\u0026viewer=simple":{}};
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"Y+MEd66gvPGy8an5igFrm8oBvGoeJLJuHO3WhnSOX7flUKHfSp4t2lpOGjKf2VJpC05alvf08LJk477qXNXPmg==","x-gitlab-feature-category":"source_code_management"};
...
<meta content="db/generated/gen.py · main · compsci316 / Mini Amazon Skeleton" property="og:title">
...
<meta content="https://gitlab.oit.duke.edu/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="db/generated/gen.py · main · compsci316 / Mini Amazon Skeleton" property="twitter:title">
...
<title>db/generated/gen.py · main · compsci316 / Mini Amazon Skeleton · GitLab</title>
<meta content="GitLab Community Edition" name="description">
<link rel="prefetch" href="/assets/webpack/monaco.b1fdb3f3.chunk.js">
...
<script>
//<![CDATA[
window.gon={};gon.features={"refactorBlobViewer":false,"refactorTextViewer":false,"consolidatedEditButton":false};
//]]>
</script>
...
<script src="/assets/webpack/commons-pages.projects.blob.show-pages.projects.show-pages.projects.snippets.edit-pages.projects.sni-42df7d4c.55046e02.chunk.js" defer="defer"></script>
<script src="/assets/webpack/commons-pages.projects.blame.show-pages.projects.blob.edit-pages.projects.blob.new-pages.projects.bl-c6edf1dd.964ee4ec.chunk.js" defer="defer"></script>
<script src="/assets/webpack/commons-pages.projects.blob.show-pages.projects.show-pages.projects.snippets.show-pages.projects.tre-c684fcf6.b553b177.chunk.js" defer="defer"></script>
<script src="/assets/webpack/commons-pages.projects.blob.show-pages.projects.show-pages.projects.tree.show.9f30d63c.chunk.js" defer="defer"></script>
<script src="/assets/webpack/pages.projects.blob.show.a8aa110e.chunk.js" defer="defer"></script>
<script>
//<![CDATA[
window.uploads_path = "/compsci316/mini-amazon-skeleton/uploads";
...
<meta name="csrf-token" content="nXkkqptWgrhvPeJlwBLkkEpnnxqM4JTUUNbbkFOMmOEbyoECf2gTk4eCUa7Vyt1iiyh55mUw1ggo2LP8e9cIzA==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8 gl-browser-safari gl-platform-mac" data-find-file="/compsci316/mini-amazon-skeleton/-/find_file/main" data-group="compsci316" data-namespace-id="120" data-page="projects:blob:show" data-page-type-id="main/db/generated/gen.py" data-project="mini-amazon-skeleton" data-project-id="21525">
...
<li><a data-track-action="click_link_new_issue" data-track-label="plus_menu_dropdown" data-qa-selector="new_issue_link" href="/compsci316/mini-amazon-skeleton/-/issues/new">New issue</a></li>
<li class="divider"></li>
<li class="dropdown-bold-header">
GitLab
</li>
...
<input type="hidden" name="group_id" id="group_id" value="120" class="js-search-group-options" data-group-path="compsci316" data-name="compsci316" data-issues-path="/groups/compsci316/-/issues" data-mr-path="/groups/compsci316/-/merge_requests" />
<input type="hidden" name="project_id" id="search_project_id" value="21525" class="js-search-project-options" data-project-path="mini-amazon-skeleton" data-name="Mini Amazon Skeleton" data-issues-path="/compsci316/mini-amazon-skeleton/-/issues" data-mr-path="/compsci316/mini-amazon-skeleton/-/merge_requests" data-issues-disabled="false" />
<input type="hidden" name="scope" id="scope" />
<input type="hidden" name="search_code" id="search_code" value="true" />
<input type="hidden" name="snippets" id="snippets" value="false" />
<input type="hidden" name="repository_ref" id="repository_ref" value="main" />
<input type="hidden" name="nav_source" id="nav_source" value="navbar" />
<div class="search-autocomplete-opts hide" data-autocomplete-path="/search/autocomplete" data-autocomplete-project-id="21525" data-autocomplete-project-ref="main"></div>
</form></div>

</li>
<li class="nav-item d-none d-sm-inline-block d-lg-none">
<a title="Search" aria-label="Search" data-toggle="tooltip" data-placement="bottom" data-container="body" href="/search?project_id=21525"><svg class="s16" data-testid="search-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#search"></use></svg>
</a></li>
<li class="user-counter"><a title="Issues" class="dashboard-shortcuts-issues" aria-label="Issues" data-qa-selector="issues_shortcut_button" data-toggle="tooltip" data-placement="bottom" data-track-label="main_navigation" data-track-action="click_issues_link" data-track-property="navigation" data-container="body" href="/dashboard/issues?assignee_username=yj112"><svg class="s16" data-testid="issues-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#issues"></use></svg>
<span class="badge badge-pill issues-count green-badge hidden">
0
</span>
</a></li><li class="user-counter dropdown"><a class="dashboard-shortcuts-merge_requests" title="Merge requests" aria-label="Merge requests" data-qa-selector="merge_requests_shortcut_button" data-toggle="dropdown" data-placement="bottom" data-track-label="main_navigation" data-track-action="click_merge_link" data-track-property="navigation" data-container="body" href="/dashboard/merge_requests?assignee_username=yj112"><svg class="s16" data-testid="git-merge-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#git-merge"></use></svg>
...
<li>
<a class="gl-display-flex! gl-align-items-center" href="/dashboard/merge_requests?assignee_username=yj112">Assigned to you
<span class="badge gl-badge badge-pill badge-muted merge-request-badge gl-ml-auto js-assigned-mr-count">
0
</span>
</a></li>
<li>
<a class="gl-display-flex! gl-align-items-center" href="/dashboard/merge_requests?reviewer_username=yj112">Review requests for you
...
<a class="header-user-dropdown-toggle" data-toggle="dropdown" href="/yj112"><img width="23" height="23" class="header-user-avatar qa-user-avatar lazy" alt="Young Jun" data-src="https://secure.gravatar.com/avatar/e47d4640ad74480c8e8364fa2c38e819?s=46&amp;d=identicon" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" />

<svg class="s16 caret-down" data-testid="chevron-down-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#chevron-down"></use></svg>
</a><div class="dropdown-menu dropdown-menu-right">
<ul>
<li class="current-user">
<a class="gl-line-height-20!" data-user="yj112" data-testid="user-profile-link" data-qa-selector="user_profile_link" href="/yj112"><div class="gl-font-weight-bold">
Young Jun
</div>
@yj112
...
<li data-track-label="scope_menu" data-container="body" data-placement="right" class="context-header has-tooltip" title="Mini Amazon Skeleton"><a aria-label="Mini Amazon Skeleton" class="shortcuts-project rspec-project-link" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Project scope" href="/compsci316/mini-amazon-skeleton"><span class="avatar-container rect-avatar s32 project_avatar">
...
<li data-track-label="project_information_menu" class="home"><a aria-label="Project information" class="shortcuts-project-information has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Project information" href="/compsci316/mini-amazon-skeleton/activity"><span class="nav-icon-container">
...
<li data-track-label="activity" class=""><a aria-label="Activity" class="shortcuts-project-activity" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Activity" href="/compsci316/mini-amazon-skeleton/activity"><span>
Activity
</span>
</a></li><li data-track-label="labels" class=""><a aria-label="Labels" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Labels" href="/compsci316/mini-amazon-skeleton/-/labels"><span>
Labels
</span>
</a></li><li data-track-label="members" class=""><a aria-label="Members" id="js-onboarding-members-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Members" href="/compsci316/mini-amazon-skeleton/-/project_members"><span>
Members
</span>
</a></li>
</ul>
</li><li data-track-label="repository_menu" class="active"><a aria-label="Repository" class="shortcuts-tree has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Repository" href="/compsci316/mini-amazon-skeleton/-/tree/main"><span class="nav-icon-container">
...
<li data-track-label="files" class="active"><a aria-label="Files" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Files" href="/compsci316/mini-amazon-skeleton/-/tree/main"><span>
Files
</span>
</a></li><li data-track-label="commits" class=""><a aria-label="Commits" id="js-onboarding-commits-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Commits" href="/compsci316/mini-amazon-skeleton/-/commits/main"><span>
Commits
</span>
</a></li><li data-track-label="branches" class=""><a aria-label="Branches" id="js-onboarding-branches-link" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Branches" href="/compsci316/mini-amazon-skeleton/-/branches"><span>
Branches
</span>
</a></li><li data-track-label="tags" class=""><a aria-label="Tags" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Tags" href="/compsci316/mini-amazon-skeleton/-/tags"><span>
Tags
</span>
</a></li><li data-track-label="contributors" class=""><a aria-label="Contributors" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Contributors" href="/compsci316/mini-amazon-skeleton/-/graphs/main"><span>
Contributors
</span>
</a></li><li data-track-label="graphs" class=""><a aria-label="Graph" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Graph" href="/compsci316/mini-amazon-skeleton/-/network/main"><span>
Graph
</span>
</a></li><li data-track-label="compare" class=""><a aria-label="Compare" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Compare" href="/compsci316/mini-amazon-skeleton/-/compare?from=main&amp;to=main"><span>
Compare
</span>
</a></li>
</ul>
</li><li data-track-label="issues_menu" class=""><a aria-label="Issues" class="shortcuts-issues has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Issues" href="/compsci316/mini-amazon-skeleton/-/issues"><span class="nav-icon-container">
...
<li data-track-label="issue_list" class=""><a aria-label="Issues" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="List" href="/compsci316/mini-amazon-skeleton/-/issues"><span>
List
</span>
</a></li><li data-track-label="boards" class=""><a aria-label="Boards" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Boards" href="/compsci316/mini-amazon-skeleton/-/boards"><span>
Boards
</span>
</a></li><li data-track-label="service_desk" class=""><a aria-label="Service Desk" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Service Desk" href="/compsci316/mini-amazon-skeleton/-/issues/service_desk"><span>
Service Desk
</span>
</a></li><li data-track-label="milestones" class=""><a aria-label="Milestones" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Milestones" href="/compsci316/mini-amazon-skeleton/-/milestones"><span>
Milestones
</span>
</a></li>
</ul>
</li><li data-track-label="merge_requests_menu" class=""><a aria-label="Merge requests" class="shortcuts-merge_requests" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Merge requests" href="/compsci316/mini-amazon-skeleton/-/merge_requests"><span class="nav-icon-container">
...
</li><li data-track-label="ci_cd_menu" class=""><a aria-label="CI/CD" class="shortcuts-pipelines rspec-link-pipelines has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="CI/CD" href="/compsci316/mini-amazon-skeleton/-/pipelines"><span class="nav-icon-container">
...
<li data-track-label="pipelines" class=""><a aria-label="Pipelines" class="shortcuts-pipelines" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Pipelines" href="/compsci316/mini-amazon-skeleton/-/pipelines"><span>
Pipelines
</span>
</a></li><li data-track-label="jobs" class=""><a aria-label="Jobs" class="shortcuts-builds" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Jobs" href="/compsci316/mini-amazon-skeleton/-/jobs"><span>
Jobs
</span>
</a></li><li data-track-label="pipeline_schedules" class=""><a aria-label="Schedules" class="shortcuts-builds" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Schedules" href="/compsci316/mini-amazon-skeleton/-/pipeline_schedules"><span>
Schedules
</span>
</a></li>
</ul>
</li><li data-track-label="deployments_menu" class=""><a aria-label="Deployments" class="shortcuts-deployments has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Deployments" href="/compsci316/mini-amazon-skeleton/-/environments"><span class="nav-icon-container">
...
<li data-track-label="environments" class=""><a aria-label="Environments" class="shortcuts-environments" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Environments" href="/compsci316/mini-amazon-skeleton/-/environments"><span>
Environments
</span>
</a></li><li data-track-label="releases" class=""><a aria-label="Releases" class="shortcuts-deployments-releases" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Releases" href="/compsci316/mini-amazon-skeleton/-/releases"><span>
Releases
</span>
</a></li>
</ul>
</li><li data-track-label="monitor_menu" class=""><a aria-label="Monitor" class="shortcuts-monitor has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Monitor" href="/compsci316/mini-amazon-skeleton/-/incidents"><span class="nav-icon-container">
...
<li data-track-label="incidents" class=""><a aria-label="Incidents" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Incidents" href="/compsci316/mini-amazon-skeleton/-/incidents"><span>
Incidents
</span>
</a></li>
</ul>
</li><li data-track-label="packages_registries_menu" class=""><a aria-label="Packages &amp; Registries" class="has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Packages &amp; Registries" href="/compsci316/mini-amazon-skeleton/-/packages"><span class="nav-icon-container">
...
<li data-track-label="packages_registry" class=""><a aria-label="Package Registry" class="shortcuts-container-registry" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Package Registry" href="/compsci316/mini-amazon-skeleton/-/packages"><span>
Package Registry
</span>
</a></li><li data-track-label="container_registry" class=""><a aria-label="Container Registry" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Container Registry" href="/compsci316/mini-amazon-skeleton/container_registry"><span>
Container Registry
</span>
</a></li><li data-track-label="infrastructure_registry" class=""><a aria-label="Infrastructure Registry" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Infrastructure Registry" href="/compsci316/mini-amazon-skeleton/-/infrastructure_registry"><span>
Infrastructure Registry
</span>
</a></li>
</ul>
</li><li data-track-label="analytics_menu" class=""><a aria-label="Analytics" class="shortcuts-analytics has-sub-items" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Analytics" href="/compsci316/mini-amazon-skeleton/-/value_stream_analytics"><span class="nav-icon-container">
...
<li data-track-label="ci_cd_analytics" class=""><a aria-label="CI/CD" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="CI/CD" href="/compsci316/mini-amazon-skeleton/-/pipelines/charts"><span>
CI/CD
</span>
</a></li><li data-track-label="repository_analytics" class=""><a aria-label="Repository" class="shortcuts-repository-charts" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Repository" href="/compsci316/mini-amazon-skeleton/-/graphs/main/charts"><span>
Repository
</span>
</a></li><li data-track-label="cycle_analytics" class=""><a aria-label="Value stream" class="shortcuts-project-cycle-analytics" data-qa-selector="sidebar_menu_item_link" data-qa-menu-item="Value stream" href="/compsci316/mini-amazon-skeleton/-/value_stream_analytics"><span>
Value stream
</span>
</a></li>
</ul>
</li><li data-track-label="wiki_menu" class=""><a aria-label="Wiki" class="shortcuts-wiki" data-qa-selector="sidebar_menu_link" data-qa-menu-item="Wiki" href="/compsci316/mini-amazon-skeleton/-/wikis/home"><span class="nav-icon-container">
...
<li class="hidden">
<a aria-label="Activity" class="shortcuts-project-activity" href="/compsci316/mini-amazon-skeleton/activity">Activity
</a></li>
<li class="hidden">
<a aria-label="Graph" class="shortcuts-network" href="/compsci316/mini-amazon-skeleton/-/network/main">Graph
</a></li>
<li class="hidden">
<a aria-label="Create a new issue" class="shortcuts-new-issue" href="/compsci316/mini-amazon-skeleton/-/issues/new">Create a new issue
</a></li>
<li class="hidden">
<a aria-label="Jobs" class="shortcuts-builds" href="/compsci316/mini-amazon-skeleton/-/jobs">Jobs
</a></li>
<li class="hidden">
<a aria-label="Commits" class="shortcuts-commits" href="/compsci316/mini-amazon-skeleton/-/commits/main">Commits
</a></li>
<li class="hidden">
<a aria-label="Issue Boards" class="shortcuts-issue-boards" href="/compsci316/mini-amazon-skeleton/-/boards">Issue Boards
</a></li>
...
<li><a class="group-path breadcrumb-item-text js-breadcrumb-item-text " href="/compsci316">compsci316</a><svg class="s8 breadcrumbs-list-angle" data-testid="angle-right-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#angle-right"></use></svg></li> <li><a href="/compsci316/mini-amazon-skeleton"><span class="breadcrumb-item-text js-breadcrumb-item-text">Mini Amazon Skeleton</span></a><svg class="s8 breadcrumbs-list-angle" data-testid="angle-right-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#angle-right"></use></svg></li>

<li>
<h2 class="breadcrumbs-sub-title" data-qa-selector="breadcrumb_sub_title_content">
<a href="/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py">Repository</a>
</h2>
</li>
</ul>
</div>
<script type="application/ld+json">
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"compsci316","item":"https://gitlab.oit.duke.edu/compsci316"},{"@type":"ListItem","position":2,"name":"Mini Amazon Skeleton","item":"https://gitlab.oit.duke.edu/compsci316/mini-amazon-skeleton"},{"@type":"ListItem","position":3,"name":"Repository","item":"https://gitlab.oit.duke.edu/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py"}]}
...
<div class="js-signature-container" data-signatures-path="/compsci316/mini-amazon-skeleton/-/commits/cda0759551eb214ac376f89ada4bded5f6ebc9b0/signatures?limit=1"></div>

<div class="tree-holder" id="tree-holder">
<div class="nav-block">
<div class="tree-ref-container">
<div class="tree-ref-holder">
<form class="project-refs-form" action="/compsci316/mini-amazon-skeleton/-/refs/switch" accept-charset="UTF-8" method="get"><input type="hidden" name="destination" id="destination" value="blob" />
<input type="hidden" name="path" id="path" value="db/generated/gen.py" />
<div class="dropdown">
<button class="dropdown-menu-toggle js-project-refs-dropdown qa-branches-select" type="button" data-toggle="dropdown" data-selected="main" data-ref="main" data-refs-url="/compsci316/mini-amazon-skeleton/refs?sort=updated_desc" data-field-name="ref" data-submit-form-on-click="true" data-visit="true"><span class="dropdown-toggle-text ">main</span><svg class="s16 dropdown-menu-toggle-icon gl-top-3" data-testid="chevron-down-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#chevron-down"></use></svg></button>
...
<a href="/compsci316/mini-amazon-skeleton/-/tree/main">mini-amazon-skeleton
</a></li>
<li class="breadcrumb-item">
<a href="/compsci316/mini-amazon-skeleton/-/tree/main/db">db</a>
</li>
<li class="breadcrumb-item">
<a href="/compsci316/mini-amazon-skeleton/-/tree/main/db/generated">generated</a>
</li>
<li class="breadcrumb-item">
<a href="/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py"><strong>gen.py</strong>
</a></li>
</ul>
</div>
<div class="tree-controls gl-children-ml-sm-3"><a class="gl-button btn btn-default shortcuts-find-file" rel="nofollow" href="/compsci316/mini-amazon-skeleton/-/find_file/main">Find file
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/compsci316/mini-amazon-skeleton/-/blame/main/db/generated/gen.py">Blame</a><a class="gl-button btn btn-default" href="/compsci316/mini-amazon-skeleton/-/commits/main/db/generated/gen.py">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/compsci316/mini-amazon-skeleton/-/blob/cda0759551eb214ac376f89ada4bded5f6ebc9b0/db/generated/gen.py">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-cda07595">
<div class="avatar-cell d-none d-sm-block">
<a href="mailto:junyang@duke.edu"><img alt="Jun Yang&#39;s avatar" src="/uploads/-/system/user/avatar/87/portrait.jpg?width=40" class="avatar s40 d-none d-sm-inline-block" title="Jun Yang" /></a>
</div>
<div class="commit-detail flex-list">
<div class="commit-content" data-qa-selector="commit_content">
<a class="commit-row-message item-title js-onboarding-commit-item " href="/compsci316/mini-amazon-skeleton/-/commit/cda0759551eb214ac376f89ada4bded5f6ebc9b0">fixed a minor bug in data generation</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
cda07595
</span>
<div class="committer">
<a class="commit-author-link" href="mailto:junyang@duke.edu">Jun Yang</a> authored <time class="js-timeago" title="Nov 2, 2021 12:17am" datetime="2021-11-02T04:17:26Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Nov 02, 2021</time>
</div>

</div>
<div class="commit-actions flex-row">

<div class="js-commit-pipeline-status" data-endpoint="/compsci316/mini-amazon-skeleton/-/commit/cda0759551eb214ac376f89ada4bded5f6ebc9b0/pipelines?ref=main"></div>
<div class="commit-sha-group btn-group d-none d-sm-flex">
<div class="label label-monospace monospace">
cda07595
</div>
<button class="btn gl-button btn btn-default btn-icon" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="gl-button btn btn-default btn-icon" data-clipboard-text="cda0759551eb214ac376f89ada4bded5f6ebc9b0" type="button" title="Copy commit SHA" aria-label="Copy commit SHA"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#copy-to-clipboard"></use></svg></button>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;db/generated/gen.py&quot;,&quot;gfm&quot;:&quot;`db/generated/gen.py`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
2.35 KB
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><button name="button" type="submit" class="btn gl-button btn-confirm js-edit-blob gl-ml-3  js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/compsci316/mini-amazon-skeleton/-/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fcompsci316%2Fmini-amazon-skeleton%2F-%2Fedit%2Fmain%2Fdb%2Fgenerated%2Fgen.py&amp;namespace_key=4358">Edit</button><button name="button" type="submit" class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted js-edit-blob-link-fork-toggler" data-action="edit" data-fork-path="/compsci316/mini-amazon-skeleton/-/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2F-%2Fide%2Fproject%2Fyj112%2Fmini-amazon-skeleton%2Fedit%2Fmain%2F-%2Fdb%2Fgenerated%2Fgen.py&amp;namespace_key=4358">Web IDE</button><div class="btn-group gl-ml-3" role="group">

<button name="button" type="submit" class="btn gl-button btn-default btn-default js-edit-blob-link-fork-toggler" data-action="replace" data-fork-path="/compsci316/mini-amazon-skeleton/-/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+replace+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fcompsci316%2Fmini-amazon-skeleton%2F-%2Fblob%2Fmain%2Fdb%2Fgenerated%2Fgen.py&amp;namespace_key=4358">Replace</button>
<button name="button" type="submit" class="btn gl-button btn-default btn-default js-edit-blob-link-fork-toggler" data-action="delete" data-fork-path="/compsci316/mini-amazon-skeleton/-/forks?continue%5Bnotice%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+has+been+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.+Try+to+delete+this+file+again.&amp;continue%5Bnotice_now%5D=You%27re+not+allowed+to+make+changes+to+this+project+directly.+A+fork+of+this+project+is+being+created+that+you+can+make+changes+in%2C+so+you+can+submit+a+merge+request.&amp;continue%5Bto%5D=%2Fcompsci316%2Fmini-amazon-skeleton%2F-%2Fblob%2Fmain%2Fdb%2Fgenerated%2Fgen.py&amp;namespace_key=4358">Delete</button>
</div><div class="btn-group gl-ml-3" role="group">
<span class="btn-group has-tooltip js-copy-blob-source-btn-tooltip"><button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-hide-tooltip="true" data-clipboard-target=".blob-content[data-blob-id=&#39;71cb8062fde987a9426c0e436843fcc31b994129&#39;] &gt; pre" type="button" title="Copy" aria-label="Copy"><svg class="s16 gl-icon" data-testid="copy-to-clipboard-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#copy-to-clipboard"></use></svg></button></span>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/compsci316/mini-amazon-skeleton/-/raw/main/db/generated/gen.py"><svg class="s16" data-testid="doc-code-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#doc-code"></use></svg></a>
<a download="db/generated/gen.py" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/compsci316/mini-amazon-skeleton/-/raw/main/db/generated/gen.py?inline=false"><svg class="s16" data-testid="download-icon"><use href="/assets/icons-74e006cef5a76d001c81e4dda159833de67bd6dbd16e42db899bbe43f2a76cf2.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-confirm-secondary" rel="nofollow" data-method="post" href="/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py">Fork</a>
...
<div class="blob-viewer" data-path="db/generated/gen.py" data-type="simple" data-url="/compsci316/mini-amazon-skeleton/-/blob/main/db/generated/gen.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace gen.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/compsci316/mini-amazon-skeleton/-/update/main/db/generated/gen.py" accept-charset="UTF-8" method="post"><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="G7oeYYFldHwLgRJ+W+MSBdfPAL8CHm14zJpK3kwN+cWdCbvJZVvlV+M+obVOOyv3FoDmQ+vOL6S0lCKyZFZp6A==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-34bfbe2a4679d4efd7a4ceb3ed0ca0df">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-34bfbe2a4679d4efd7a4ceb3ed0ca0df" class="form-control gl-form-input js-commit-message" placeholder="Replace gen.py" data-qa-selector="commit_message_field" required="required" rows="3">
Replace gen.py</textarea>
</div>
</div>
</div>
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/yj112/mini-amazon-skeleton/edit/main/-/db/generated/gen.py'
